...
export const siteMedia = {
  ...
  services: {
    storm: `${HJH}/More_pictures/More pictures/20250311_133828.jpg`,
    excavation: `${HJH}/Excavation_and_Earthwork/HJH_photo_020.webp`,
    dirtWork: `${HJH}/More_pictures/More pictures/20240616_110835.jpg`,
    landClearing: `${HJH}/Excavation_and_Earthwork/Sparrow-Clearing-1.jpg.webp`,
...
export const homeProjectCards = [
  ...
  {
    src: `${HJH}/Excavation_and_Earthwork/Sparrow-Clearing-1.jpg.webp`,
    alt: 'Land clearing equipment removing brush and timber on an Oklahoma property',
